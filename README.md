...
**Marketing Performance & ROI Dashboard**

Sessions · Conversions · Ad Spend · ROAS · Campaign ROI — all in one Power BI dashboard.
...
Campaign Compass is a Power BI dashboard that brings marketing performance and ROI into one view — tracking sessions, conversions, ad spend, ROAS, and campaign-level ROI across channels and platforms, so you can see what's working and what isn't at a glance.
...
- **Power BI Desktop** — modeling, DAX, and report design
- **Data sources** — GA4 (sessions, channels), Google Ads / Meta Ads (spend, conversions, ROAS), campaign performance tables
- **Custom visual** — Inforiver, used for channel spend/revenue/ROAS status
...
1. Clone this repo.
   ```bash
   git clone https://github.com/<your-username>/campaign-compass-dashboard.git
   ```
...
If this dashboard helped you, consider ⭐ starring the repo!
